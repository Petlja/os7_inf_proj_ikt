...
project = 'Приручник за 7. разред за пројектни задатак - информационо комуникационе технологије'
...
html_short_title ='Приручник за 7. разред за пројектни задатак - информационо комунакционе технологије'
